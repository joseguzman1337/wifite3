...
class Tshark(Dependency):
    ...
    def bssids_with_handshakes(capfile, bssid=None):
        ...
        command = [
            ...
            "-Y",
            "eapol",  # Filter for only handshakes
        ]
    ...
    def check_for_wps_and_update_targets(capfile, targets):
        ...
        command = [
            ...
            "-T",
            "fields",  # Only output certain fields
            "-e",
            "wlan.ta",  # BSSID
            "-e",
            "wps.ap_setup_locked",  # Locked status
            "-E",
            "separator=,",  # CSV
        ]
        p = Process(command)
...
if __name__ == "__main__":
    ...
    print(
        "Target(BSSID={}).wps = {} (Expected: 1)".format(
