...
class Arguments(object):
    ...
    def _add_hashcat_realtime_args(self, hrt):
        hrt.add_argument(
            ...
            help=Color.s(
                "Enable real-time Hashcat cracking for captured PMKIDs and WPA handshakes (default: {G}off{W})"
            ),
        )
        hrt.add_argument(
            "--hashcat-realtime-wordlist-dir",
            action="store",
            dest="hashcat_realtime_wordlist_dir",
            metavar="<directory>",
            default="/usr/share/wordlists/",  # Sensible default
            help=Color.s(
                "Directory of wordlists for real-time Hashcat cracking (default: {G}/usr/share/wordlists/{W})"
            ),
        )
        hrt.add_argument(
            "--hashcat-realtime-wordlist-file",
            action="store",
            dest="hashcat_realtime_wordlist_file",
            metavar="<file>",
            default=None,
            help=Color.s(
                "Specific wordlist file for real-time Hashcat cracking (overrides directory search)"
            ),
        )
        hrt.add_argument(
            "--hashcat-realtime-options",
            action="store",
            dest="hashcat_realtime_options",
            metavar="<options_str>",
            default=None,
            help=Color.s(
                'Custom options string for Hashcat real-time sessions (e.g., "--increment --increment-min=4")'
            ),
        )
        hrt.add_argument(
            "--hashcat-realtime-force-cpu",
            action="store_true",
            dest="hashcat_realtime_force_cpu",
            help=Color.s(
                "Force Hashcat to use CPU for real-time cracking (adds --force and device type CPU) (default: {G}off{W})"
            ),
        )
        hrt.add_argument(
            "--hashcat-realtime-gpu-devices",
            action="store",
            dest="hashcat_realtime_gpu_devices",
            metavar="<ids_str>",
            default=None,
            help=Color.s(
                'GPU device IDs for Hashcat real-time (e.g., "1,3" for --opencl-device-types 2 --opencl-device-ids 1,3) (default: {G}Hashcat auto{W})'
            ),
        )
    ...
    def _add_global_args(self, glob):
        glob.add_argument(
            ...
            dest="verbose",
            help=Color.s(
                "Shows more options ({C}-h -v{W}). Prints commands and "
        ...
        glob.add_argument(
            ...
            type=str,
            help=Color.s(
                "Wireless interface to use, e.g. {C}wlan0mon{W} "
                + "(default: {G}ask{W})"
            ),
        )
        ...
        glob.add_argument(
            ...
            help=Color.s(
                "Kill processes that conflict with Airmon/Airodump "
                + "(default: {G}off{W})"
            ),
        )
        ...
        glob.add_argument(
            ...
            dest="no_deauth",
            help=Color.s(
                "Passive mode: Never deauthenticates clients "
        ...
        glob.add_argument(
            ...
            default=None,
            help=self._verbose(
                "Number of deauth packets to send (default: "
    ...
    def _add_wep_args(self, wep):
        ...
        wep.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Packets-per-second to replay (default: "
        ...
        wep.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Seconds to wait before failing (default: "
        ...
        wep.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Start cracking at this many IVs (default: "
        ...
        wep.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Restart aireplay if no new IVs appear (default: "
        ...
        wep.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Restart aircrack after this delay (default: "
        ...
        wep.add_argument(
            ...
            help=self._verbose(
                "Use {C}fragmentation{W} WEP attack (default: {G}on{W})"
            ),
        )
        wep.add_argument(
            "-fragment",
    ...
    def _add_wpa_args(self, wpa):
        ...
        wpa.add_argument(
            ...
            type=str,
            help=self._verbose(
                "Directory to store handshake files "
        ...
        wpa.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Time to wait between sending Deauths "
        ...
        wpa.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Time to wait before failing WPA attack "
    ...
    def _add_wps_args(self, wps):
        ...
        wps.add_argument(
            ...
            dest="no_wps",
            help=self._verbose(
                "{O}Never{W} use {O}WPS PIN{W} & {O}Pixie-Dust{W}"
        ...
        wps.add_argument(
            ...
            dest="wps_only",
            help=Color.s(
                "{O}Only{W} use {C}WPS PIN{W} & {C}Pixie-Dust{W} "
        ...
        wps.add_argument(
            ...
            dest="wps_pixie",
            help=self._verbose(
                "{O}Only{W} use {C}WPS Pixie-Dust{W} attack "
        ...
        wps.add_argument(
            ...
            dest="wps_no_pixie",
            help=self._verbose(
                "{O}Never{W} use {O}WPS Pixie-Dust{W} attack "
                + "(use {G}PIN attack{W})"
            ),
        )
        ...
        wps.add_argument(
            ...
            dest="use_bully",
            help=Color.s(
                "Use {G}bully{W} program for WPS PIN & Pixie-Dust attacks "
                + "(default: {G}reaver{W})"
            ),
        )
        # Alias
        ...
        wps.add_argument(
            "--ignore-locks",
            action="store_true",
            dest="wps_ignore_lock",
            help=Color.s(
                "Do {O}not{W} stop WPS PIN attack if AP becomes {O}locked{W} "
                + " (default: {G}stop{W})"
            ),
        )
        ...
        wps.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Total time to wait before failing PixieDust attack "
        ...
        wps.add_argument(
            ...
            type=int,
            help=self._verbose(
                "Maximum number of Timeouts before failing "
    ...
    def _add_pmkid_args(self, pmkid):
        pmkid.add_argument(
            ...
            dest="use_pmkid_only",
            help=Color.s(
                "{O}Only{W} use {C}PMKID capture{W}, avoids other WPS & "
        ...
        pmkid.add_argument(
            ...
            type=int,
            help=Color.s(
                "Time to wait for PMKID capture "
    ...
    def _add_command_args(self, commands):
        ...
        commands.add_argument(
            ...
            help=Color.s(
                "Check a {C}.cap file{W} (or all {C}hs/*.cap{W} files) "
                + "for WPA handshakes"
            ),
        )
        commands.add_argument(
